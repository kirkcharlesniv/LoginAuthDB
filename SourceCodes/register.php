...
if(isset($_POST['btn-signup'])) {
 ...
 if ($count==0) {
  ...
  if ($res) {
   $errTyp = "success";
   $errMSG = "Your account have been successfully registered! You may login now!";
  } else {
   $errTyp = "danger";
...
<title>Prospekt | Member's Area | Register</title>
...
<div class="container">
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group">
             <button type="submit" class="btn btn-block btn-primary" name="btn-signup">Sign Me Up!</button>
            </div>
            ...
            <div class="form-group"><p> Already Registered?
             <a href="index.php"> Login now!</a></p>
            </div>
